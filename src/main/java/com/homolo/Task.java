...
public class Task {
    ...
    public void show() throws ParseException {
        ...
        Document document1=new Document("name","jack")
                .append("job","engineer")
                .append("birth",new SimpleDateFormat("yyyy-MM-dd").parse("1995-01-23"))
                .append("dept","1")
                .append("salary",5000)
                .append("remark","");
        ...
        Document document2=new Document("name","joh")
                .append("job","engineer")
                .append("birth",new SimpleDateFormat("yyyy-MM-dd").parse("1995-01-24"))
                .append("job","engineer")
                .append("dept","1")
                .append("salary",7000)
                .append("remark","");
        ...
        Document document3=new Document("name","james")
                .append("job","engineer")
                .append("birth",new SimpleDateFormat("yyyy-MM-dd").parse("1995-01-25"))
                .append("job","engineer")
                .append("dept","2")
                .append("salary",6000)
                .append("remark","");
        ...
        Document document4=new Document("name","jane")
                .append("job","engineer")
                .append("birth",new SimpleDateFormat("yyyy-MM-dd").parse("1995-01-26"))
                .append("job","engineer")
                .append("dept","2")
                .append("salary",1500)
                .append("remark","");
        ...
        Date startdate=dateFormat.parse("2019-01-1");
        Date enddate=dateFormat.parse("2019-01-31");
